...
TEST(JsonLexerTest, ExecuteLexer) {
    ...
    struct json_lexer_token_t tokens[] = {
        { .type = JLT_LPAIR, .text = &json_str[0], .index = 0, .start = 1, .end = 1, .column = 1, .row = 1 },
        { .type = JLT_STRING, .text = &json_str[2], .index = 1, .start = 3, .end = 5, .column = 2, .row = 1 },
        { .type = JLT_COLON, .text = &json_str[6], .index = 2, .start = 7, .end = 7, .column = 7, .row = 1 },
        { .type = JLT_STRING, .text = &json_str[8], .index = 3, .start = 9, .end = 13, .column = 8, .row = 1 },
        { .type = JLT_RPAIR, .text = &json_str[14], .index = 4, .start = 15, .end = 15, .column = 15, .row = 1 },
    };
...
TEST(JsonLexerTest, ExecuteLexerSingleToken) {
    ...
    struct testcase_t testcases[] = {
        { .str = "{", .token = { .type = JLT_LPAIR, .text = "{", .index = 0, .start = 1, .end = 1, .column = 1, .row = 1 } },
        { .str = "}", .token = { .type = JLT_RPAIR, .text = "}", .index = 0, .start = 1, .end = 1, .column = 1, .row = 1 } },
        { .str = "[", .token = { .type = JLT_LARRAY, .text = "[", .index = 0, .start = 1, .end = 1, .column = 1, .row = 1 } },
        { .str = "]", .token = { .type = JLT_RARRAY, .text = "]", .index = 0, .start = 1, .end = 1, .column = 1, .row = 1 } },
        { .str = ":", .token = { .type = JLT_COLON, .text = ":", .index = 0, .start = 1, .end = 1, .column = 1, .row = 1 } },
        { .str = ",", .token = { .type = JLT_COMMA, .text = ",", .index = 0, .start = 1, .end = 1, .column = 1, .row = 1 } },
        { .str = "true", .token = { .type = JLT_TRUE, .text = "true", .index = 0, .start = 1, .end = 4, .column = 1, .row = 1 } },
        { .str = "false", .token = { .type = JLT_FALSE, .text = "false", .index = 0, .start = 1, .end = 5, .column = 1, .row = 1 } },
        { .str = "null", .token = { .type = JLT_NULL, .text = "null", .index = 0, .start = 1, .end = 4, .column = 1, .row = 1 } },
        { .str = " \t\r\n 123", .token = { .type = JLT_NUMBER, .text = "123", .index = 0, .start = 6, .end = 8, .column = 2, .row = 2 } },
        { .str = "0", .token = { .type = JLT_NUMBER, .text = "0", .index = 0, .start = 1, .end = 1, .column = 1, .row = 1 } },
        { .str = "123", .token = { .type = JLT_NUMBER, .text = "123", .index = 0, .start = 1, .end = 3, .column = 1, .row = 1 } },
        { .str = "-123", .token = { .type = JLT_NUMBER, .text = "-123", .index = 0, .start = 1, .end = 4, .column = 1, .row = 1 } },
        { .str = "+123", .token = { .type = JLT_NUMBER, .text = "+123", .index = 0, .start = 1, .end = 4, .column = 1, .row = 1 } },
        { .str = ".123456", .token = { .type = JLT_NUMBER, .text = ".123456", .index = 0, .start = 1, .end = 7, .column = 1, .row = 1 } },
        { .str = "123.456", .token = { .type = JLT_NUMBER, .text = "123.456", .index = 0, .start = 1, .end = 7, .column = 1, .row = 1 } },
        { .str = "-123.456", .token = { .type = JLT_NUMBER, .text = "-123.456", .index = 0, .start = 1, .end = 8, .column = 1, .row = 1 } },
        { .str = "123e456", .token = { .type = JLT_NUMBER, .text = "123e456", .index = 0, .start = 1, .end = 7, .column = 1, .row = 1 } },
        { .str = "-123e456", .token = { .type = JLT_NUMBER, .text = "-123e456", .index = 0, .start = 1, .end = 8, .column = 1, .row = 1 } },
        { .str = "123E456", .token = { .type = JLT_NUMBER, .text = "123E456", .index = 0, .start = 1, .end = 7, .column = 1, .row = 1 } },
        { .str = "-123E456", .token = { .type = JLT_NUMBER, .text = "-123E456", .index = 0, .start = 1, .end = 8, .column = 1, .row = 1 } },
        { .str = "123e+456", .token = { .type = JLT_NUMBER, .text = "123e+456", .index = 0, .start = 1, .end = 8, .column = 1, .row = 1 } },
        { .str = "-123e+456", .token = { .type = JLT_NUMBER, .text = "-123e+456", .index = 0, .start = 1, .end = 9, .column = 1, .row = 1 } },
        { .str = "123e-456", .token = { .type = JLT_NUMBER, .text = "123e-456", .index = 0, .start = 1, .end = 8, .column = 1, .row = 1 } },
        { .str = "-123e-456", .token = { .type = JLT_NUMBER, .text = "-123e-456", .index = 0, .start = 1, .end = 9, .column = 1, .row = 1 } },
        { .str = "\"test\"", .token = { .type = JLT_STRING, .text = "test\"", .index = 0, .start = 2, .end = 5, .column = 1, .row = 1 } },
        { .str = "\"\"", .token = { .type = JLT_STRING, .text = "\"", .index = 0, .start = 2, .end = 1, .column = 1, .row = 1 } },
        { .str = "\"te" "\\" "\n" "st\"", .token = { .type = JLT_STRING, .text = "te\\\nst\"", .index = 0, .start = 2, .end = 7, .column = 1, .row = 1 } },
    };
    ...
    for (int i = 0; i < testcases_len; i++) {
        ...
        EXPECT_STREQ(testcases[i].token.text, lexer->tokens.list[0].text) << "Case: " << i;
