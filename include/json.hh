...
constexpr bool json_set(union json_t *j, const char *key, int8_t value) { return json_set_obj_i8(j, key, value); }
constexpr bool json_set(union json_t *j, const char *key, int16_t value) { return json_set_obj_i16(j, key, value); }
...
constexpr bool json_set(union json_t *j, Index i, const char *value) {
    return json_set_arr_str(j, i, value);
}

// Overload for bool values
template <typename Index, typename = std::enable_if_t<std::is_integral_v<Index>>>
constexpr bool json_set(union json_t *j, Index i, bool value) {
    return json_set_arr_bool(j, i, value);
}

// Overload for void* values (typically used for setting null)
template <typename Index, typename = std::enable_if_t<std::is_integral_v<Index>>>
constexpr bool json_set(union json_t *j, Index i, void *value) {
    return json_set_arr_null(j, i, value);
}

// Overload for int8_t values
template <typename Index, typename = std::enable_if_t<std::is_integral_v<Index>>>
constexpr bool json_set(union json_t *j, Index i, int8_t value) {
    return json_set_arr_i8(j, i, value);
}

// Overload for int16_t values
template <typename Index, typename = std::enable_if_t<std::is_integral_v<Index>>>
constexpr bool json_set(union json_t *j, Index i, int16_t value) {
    return json_set_arr_i16(j, i, value);
}

// Overload for int32_t values
template <typename Index, typename = std::enable_if_t<std::is_integral_v<Index>>>
constexpr bool json_set(union json_t *j, Index i, int32_t value) {
    return json_set_arr_i32(j, i, value);
}

// Overload for int64_t values
template <typename Index, typename = std::enable_if_t<std::is_integral_v<Index>>>
constexpr bool json_set(union json_t *j, Index i, int64_t value) {
    return json_set_arr_i64(j, i, value);
}

// Overload for uint8_t values
template <typename Index, typename = std::enable_if_t<std::is_integral_v<Index>>>
constexpr bool json_set(union json_t *j, Index i, uint8_t value) {
    return json_set_arr_u8(j, i, value);
}

// Overload for uint16_t values
template <typename Index, typename = std::enable_if_t<std::is_integral_v<Index>>>
constexpr bool json_set(union json_t *j, Index i, uint16_t value) {
    return json_set_arr_u16(j, i, value);
}

// Overload for uint32_t values
template <typename Index, typename = std::enable_if_t<std::is_integral_v<Index>>>
constexpr bool json_set(union json_t *j, Index i, uint32_t value) {
    return json_set_arr_u32(j, i, value);
}

// Overload for uint64_t values
template <typename Index, typename = std::enable_if_t<std::is_integral_v<Index>>>
constexpr bool json_set(union json_t *j, Index i, uint64_t value) {
    return json_set_arr_u64(j, i, value);
}

// Overload for float values
template <typename Index, typename = std::enable_if_t<std::is_integral_v<Index>>>
constexpr bool json_set(union json_t *j, Index i, float value) {
    return json_set_arr_f32(j, i, value);
}

// Overload for double values
template <typename Index, typename = std::enable_if_t<std::is_integral_v<Index>>>
constexpr bool json_set(union json_t *j, Index i, double value) {
    return json_set_arr_f64(j, i, value);
}

// Overload for union json_t values
template <typename Index, typename = std::enable_if_t<std::is_integral_v<Index>>>
constexpr bool json_set(union json_t *j, Index i, union json_t value) {
...
constexpr bool json_append(union json_t *j, const char *value) { return json_append_str(j, value); }
constexpr bool json_append(union json_t *j, char *value) { return json_append_str(j, value); }
constexpr bool json_append(union json_t *j, bool value) { return json_append_bool(j, value); }
constexpr bool json_append(union json_t *j, void *value) { return json_append_null(j, value); }
constexpr bool json_append(union json_t *j, int8_t value) { return json_append_i8(j, value); }
constexpr bool json_append(union json_t *j, int16_t value) { return json_append_i16(j, value); }
constexpr bool json_append(union json_t *j, int32_t value) { return json_append_i32(j, value); }
constexpr bool json_append(union json_t *j, int64_t value) { return json_append_i64(j, value); }
constexpr bool json_append(union json_t *j, uint8_t value) { return json_append_u8(j, value); }
constexpr bool json_append(union json_t *j, uint16_t value) { return json_append_u16(j, value); }
constexpr bool json_append(union json_t *j, uint32_t value) { return json_append_u32(j, value); }
constexpr bool json_append(union json_t *j, uint64_t value) { return json_append_u64(j, value); }
constexpr bool json_append(union json_t *j, float value) { return json_append_f32(j, value); }
...
constexpr union json_t *json_getp(union json_t j, const char *key) { return __json_getp_from_obj(j, key); }
constexpr union json_t *json_getp(union json_t j, int i) { return __json_getp_from_arr(j, i); }

constexpr union json_t json_remove(union json_t *j, const char *key) { return __json_remove_from_obj(j, key); }
constexpr union json_t json_remove(union json_t *j, int i) { return __json_remove_from_arr(j, i); }

constexpr void json_delete(union json_t *j, const char *key) { return __json_delete_from_obj(j, key); }
constexpr void json_delete(union json_t *j, int i) { return __json_delete_from_arr(j, i); }

constexpr void json_merge(union json_t *j, union json_t from) { return __json_merge(j, from); }
constexpr void json_merge(union json_t *j, union json_t *from) { return __json_merge_p(j, from); }

constexpr void json_concat(union json_t *j, union json_t from) { return __json_concat(j, from); }
constexpr void json_concat_p(union json_t *j, union json_t *from) { return __json_concat_p(j, from); }
